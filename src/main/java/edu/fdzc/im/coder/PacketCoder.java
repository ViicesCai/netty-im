...
import edu.fdzc.im.coder.impl.JSONSerializerImpl;
import edu.fdzc.im.protocol.Command;
import edu.fdzc.im.protocol.Packet;
import edu.fdzc.im.protocol.chat.*;
...
import edu.fdzc.im.protocol.message.GroupMessageRequestPacket;
import edu.fdzc.im.protocol.message.GroupMessageResponsePacket;
